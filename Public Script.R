...
summary(sleep$stress.4days.cen<-sleep$stress.4days-mean(sleep$stress.4days))
summary (one <- lmer (sleep.efficiency ~ 1 + scent.type + (1 + scent.type | participant), data=sleep))
summary (main <- lmer (sleep.efficiency ~ 1 + scent.type + order + rel.length.cen + rel.sat.cen + AAQ_avoidance.cen + AAQ_ambivalence.cen + stress.cen + stress.4days.cen + birth.control + (1 + scent.type + stress.cen | participant), data=sleep))
...
# exclude variables participant 19
...
summary (sleep_19$stress.4days.cen<-sleep_19$stress.4days-mean(sleep_19$stress.4days))
...
summary (main3_19 <- lmer (perceived.sleep ~ 1 + scent.type + order + rel.length.cen + rel.sat.cen + AAQ_avoidance.cen + AAQ_ambivalence.cen + stress.cen + stress.4days.cen + birth.control + (1 + scent.type + stress.cen | participant), data=sleep_19))
...
#run rested and sleep EFFICIENCY on HCP (high compliance participants)
...
summary (sleep_HCP$stress.4days.cen<-sleep_HCP$stress.4days-mean(sleep_HCP$stress.4days))
summary (empty_HCP <- lmer (sleep.efficiency ~ 1 + (1 | participant), data=sleep_HCP))
summary (one_HCP <- lmer (sleep.efficiency ~ 1 + scent.type + (1 + scent.type | participant), data=sleep_HCP))
summary (main_HCP <- lmer (sleep.efficiency ~ 1 + scent.type + order + rel.length.cen + rel.sat.cen + AAQ_avoidance.cen + AAQ_ambivalence.cen + stress.cen + stress.4days.cen + birth.control + (1 + scent.type + stress.cen | participant), data=sleep_HCP))

#deviance reduction
anova(one_HCP, empty_HCP)
...
summary (one_HCP <- lmer (perceived.sleep ~ 1 + scent.type + (1 + scent.type | participant), data=sleep_HCP))
summary (main_HCP <- lmer (perceived.sleep ~ 1 + scent.type + order + rel.length.cen + rel.sat.cen + AAQ_avoidance.cen + AAQ_ambivalence.cen + stress.cen + stress.4days.cen + birth.control + (1 + scent.type + stress.cen | participant), data=sleep_HCP))
